...
resource "octopusdeploy_lifecycle" "productiononly_lifecycle" {
  ...
  phase {
    automatic_deployment_targets = []
    optional_deployment_targets  = [var.octopus_production_app_environment_name ? data.octopusdeploy_environments.production.environments[0].id : octopusdeploy_environment.production_environment[0].id]
    name                         = var.octopus_production_app_environment_name ? data.octopusdeploy_environments.production.environments[0].name : octopusdeploy_environment.production_environment[0].name
